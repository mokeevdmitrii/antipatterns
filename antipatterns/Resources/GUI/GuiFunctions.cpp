...
unsigned int gui::CalcCharacterSize(sf::VideoMode &video_mode, unsigned int normal_size) {
    return static_cast<unsigned int>(static_cast<float>(video_mode.height) / kNormalHeight) * normal_size;
}
