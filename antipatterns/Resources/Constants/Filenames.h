...
// files used in MainMenuState.h
    ...
    static const std::string kMainMenuButtonsFile = "../Config/main_menu_buttons.json";
    static const std::string kPauseMenuButtonsFile = "../Config/pause_menu_buttons.json";
    static const std::string kMainMenuStateKeybindingsFile = "../Config/main_menu_state_keybindings.txt";
    static const std::string kMainMenuBackgroundFile = "../Images/Backgrounds/main_menu.png";
