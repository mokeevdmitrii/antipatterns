...
static const std::string gamestate_keybindings_file = "../Config/gamestate_keybindings.txt";
static const std::string player_texture_sheet_file = "../Images/Sprites/Player/hero.png";
